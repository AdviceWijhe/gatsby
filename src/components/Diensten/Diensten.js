          ...
          return (
            post.wpParent === null ? (
              <AniLink paintDrip key={post.id} to={post.uri} className={`com_Diensten__Dienst block relative`}>
                <h3 className={`com_Diensten__Dienst--title relative inline`}>{post.title}<div className="triangle triangle-arrow triangle-bottom hidden lg:flex"><img src={`/icons/Pijltje_white_Lang.svg`} className="arrow arrow-right arrow-small" alt="Pijl wit lang" /></div></h3>
